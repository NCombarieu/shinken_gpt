        ...
        if [f for f in self.structured_data if f[0] == 'Negate']:
            ...
            if eq_filters == ['name']:
                ...
                try:
                    ...
                    only_hosts = False
                if only_hosts:
                    if len(hosts) == len([x for x in self.structured_data if x[0] == 'Filter' and x[1] == 'name']):
            ...
            if eq_filters == ['host_name']:
                ...
                try:
                    ...
                    only_hosts = False
                if only_hosts:
                    if len(hosts) == len([x for x in self.structured_data if x[0] == 'Filter' and x[1] == 'host_name']):
                        hosts = list(set(hosts))
                        hosts.sort()
                ...
                try:
                    ...
                    only_services = False
                if only_services:
                    if len(services) == len([x for x in self.structured_data if x[0] == 'Filter' and x[1] == 'description']):
