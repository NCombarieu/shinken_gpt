...
class TopBaseLiveStatusStack(queue.LifoQueue, object):
    pass
...
# Python 3's stdlib always has queue.LifoQueue, so TopBaseLiveStatusStack
# inherits it directly above instead of the old Python 2.4/2.5 runtime
# __bases__ swap (which Python 3 refuses: incompatible deallocators).
