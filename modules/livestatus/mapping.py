...
livestatus_attribute_map = {
    'Host': {
        ...
        'custom_variables': {
            ...
            'function': lambda item, req: [join_with_separators(req, k[1:], v) for k, v in item.customs.items()],
            'datatype': list,
        },
        'display_name': {
...
for objtype in ['Host', 'Service', 'Contact', 'Command', 'Timeperiod', 'Downtime', 'Comment', 'Hostgroup', 'Servicegroup', 'Contactgroup', 'SchedulerLink', 'PollerLink', 'ReactionnerLink', 'BrokerLink', 'Problem', 'Logline', 'Config']:
    cls = [t[1] for t in list(table_class_map.values()) if t[0] == objtype][0]
    ...
    for attribute in livestatus_attribute_map[objtype]:
        ...
        if 'function' in entry:
            ...
            if 'datatype' in entry:
                ...
                getattr(cls, 'lsm_'+attribute).datatype = entry['datatype']
                ...
                getattr(cls, 'lsm_'+attribute).datatype = int
            else:
                getattr(cls, 'lsm_'+attribute).datatype = str
            ...
            getattr(cls, 'lsm_'+attribute).datatype = getattr(Host, 'lsm_'+attribute.replace('host_', '')).datatype
            ...
            getattr(cls, 'lsm_'+attribute).datatype = getattr(Host, 'lsm_'+attribute).datatype
            ...
            getattr(cls, 'lsm_'+attribute).datatype = getattr(Service, 'lsm_'+attribute.replace('service_', '')).datatype
            ...
            getattr(cls, 'lsm_'+attribute).datatype = getattr(Service, 'lsm_'+attribute.replace('current_service_', '')).datatype
            ...
            getattr(cls, 'lsm_'+attribute).datatype = getattr(Host, 'lsm_'+attribute.replace('current_host_', '')).datatype
            ...
            getattr(cls, 'lsm_'+attribute).datatype = getattr(Contact, 'lsm_'+attribute.replace('current_contact_', '')).datatype
        else:
            pass
        ...
        getattr(cls, 'lsm_'+attribute).description = entry['description']
    if objtype == 'Host':
        ...
        for attribute in livestatus_attribute_map['Host']:
            ...
            getattr(cls, 'lsm_host_'+attribute).description = getattr(cls, 'lsm_'+attribute).description
            getattr(cls, 'lsm_host_'+attribute).datatype = getattr(cls, 'lsm_'+attribute).datatype
...
for objtype in ['Host', 'Service']:
    ...
    if objtype == 'Host':
        ...
        for attribute in livestatus_attribute_map['Hostgroup']:
            ...
            getattr(cls, 'lsm_hostgroup_'+attribute).description = getattr(Hostgroup, 'lsm_'+attribute).description
            getattr(cls, 'lsm_hostgroup_'+attribute).datatype = getattr(Hostgroup, 'lsm_'+attribute).datatype
    if objtype == 'Service':
        for attribute in livestatus_attribute_map['Servicegroup']:
            ...
            getattr(cls, 'lsm_servicegroup_'+attribute).description = getattr(Servicegroup, 'lsm_'+attribute).description
            getattr(cls, 'lsm_servicegroup_'+attribute).datatype = getattr(Servicegroup, 'lsm_'+attribute).datatype
...
for objtype in ['Host', 'Service', 'Contact', 'Command', 'Timeperiod', 'Downtime', 'Comment', 'Hostgroup', 'Servicegroup', 'Contactgroup', 'SchedulerLink', 'PollerLink', 'ReactionnerLink', 'BrokerLink', 'Problem', 'Logline', 'Config']:
    ...
    for attribute in livestatus_attribute_map[objtype]:
        entry =  livestatus_attribute_map[objtype][attribute]
        if not hasattr(getattr(cls, 'lsm_'+attribute), 'datatype'):
            getattr(cls, 'lsm_'+attribute).default = 0
        elif getattr(cls, 'lsm_'+attribute).datatype == int:
            getattr(cls, 'lsm_'+attribute).default = 0
        elif getattr(cls, 'lsm_'+attribute).datatype == float:
            getattr(cls, 'lsm_'+attribute).default = 0.0
        elif getattr(cls, 'lsm_'+attribute).datatype == str:
            getattr(cls, 'lsm_'+attribute).default = ''
        elif getattr(cls, 'lsm_'+attribute).datatype == list:
            getattr(cls, 'lsm_'+attribute).default = []
        elif getattr(cls, 'lsm_'+attribute).datatype == bool:
            getattr(cls, 'lsm_'+attribute).default = False
